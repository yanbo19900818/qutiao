...
<body topmargin="8" onload="load()">
	...
	<form method="post" id="modifyModuleFrom" name="modifyModuleFrom" action="${basePath}/cms/square/insertModule.do" ENCTYPE="multipart/form-data">
	<input type="hidden" name="moduleId"  value="${module.moduleId }" />
	<input type="hidden"  id="linkAction" value="${module.linkAction}" >
	<input type="hidden" id="api_type"  name="api_type" value="${module.apiType }"/>
								...
								<tbody>
									<tr>
										...
										<td><input type="text" id="keyWords" name="keyWords"
											value="${module.keyWords}" style="width:388px">
										</td>
									</tr>
								</tbody>
							</table>
										...
										<td width="83%"><table width="214" border="0"
												...
												<tbody>
													<tr>
														...
														<input type="hidden" id="keywordsPage" name="keywordsPage" value="${keywordsPage }"  />
