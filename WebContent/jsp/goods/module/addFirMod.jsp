				...
				<tr>
					<td colspan="2">
						<table width="800" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									<td width="84" height="24" align="center"background="${basePath}/images/itemnote1.gif">&nbsp;添加模块&nbsp;</td>
									<td width="84"></td>
									<td>&nbsp;</td>
								</tr>
							</tbody>
							...
							<table width="800" border="0" cellspacing="0" cellpadding="0">
								<tbody>
									<tr>
										...
										<td>
										   <input type="text" id="moduleTitle" name="moduleTitle" style="width:388px">
										</td>
									</tr>
									<tr>
										<td></td>
								...
								<tbody>
									<tr>
										...
										<td>
										     ...
										     彩票<input type="radio" name="apiType" id="apiType"  value ="3" onchange="nextStep();">
