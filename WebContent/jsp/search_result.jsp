...
<script src="/js/index_ding_cai.js"></script>
<script src="/js/jquery.js"></script>
<script type="text/javascript"
	src="http://qzonestyle.gtimg.cn/qzone/openapi/qc_loader.js"
	data-appid="100359685"
	data-redirecturi="http://www.qutiao.com/loginByOp.do?openType=1"
				...
				<div class="ft">
					<div class="huihui-paging">
						<m:pageTag before="${page.before}" now="${page.now}"
							...
							url="keyword_${keywordId}_{pageNum}.html" placeholder="{pageNum}"></m:pageTag>
					</div>
				</div>
			</div>
